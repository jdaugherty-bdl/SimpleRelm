...
namespace SimpleRelm.Interfaces
{
    public interface IRelmModel
    {
        ...
        int WriteToDatabase(Enum ConnectionStringType, int BatchSize = 10, bool AllowAutoIncrementColumns = false, bool AllowPrimaryKeyColumns = false);
        int WriteToDatabase(MySqlConnection ExistingConnection, MySqlTransaction SqlTransaction = null, int BatchSize = 10, bool AllowAutoIncrementColumns = false, bool AllowPrimaryKeyColumns = false);
