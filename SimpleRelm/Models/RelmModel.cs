...
namespace SimpleRelm.Models
{
    public class RelmModel : IRelmModel
    {
        ...
        */
        ...
        public int WriteToDatabase(Enum connectionStringType, int batchSize = 100, bool AllowAutoIncrementColumns = false, bool AllowPrimaryKeyColumns = false)
        {
            return DataOutputOperations.BulkTableWrite(connectionStringType, this, ForceType: this.GetType(), BatchSize: batchSize, AllowAutoIncrementColumns: AllowAutoIncrementColumns, AllowPrimaryKeyColumns: AllowPrimaryKeyColumns);
        }
        ...
        /// <param name="batchSize">The number of items to write out to the database per batch.</param>
        /// <returns>The number of rows written to the database.</returns>
        public int WriteToDatabase(IRelmContext relmContext, int batchSize = 100, bool AllowAutoIncrementColumns = false, bool AllowPrimaryKeyColumns = false)
        {
            return DataOutputOperations.BulkTableWrite(relmContext.ContextOptions.DatabaseConnection, this, SqlTransaction: relmContext.ContextOptions.DatabaseTransaction, ForceType: this.GetType(), BatchSize: batchSize, AllowAutoIncrementColumns: AllowAutoIncrementColumns, AllowPrimaryKeyColumns: AllowPrimaryKeyColumns);
        }
        ...
        /// <param name="batchSize">The number of items to write out to the database per batch.</param>
        /// <returns>The number of rows written to the database.</returns>
        public int WriteToDatabase(MySqlConnection ExistingConnection, MySqlTransaction SqlTransaction = null, int BatchSize = 100, bool AllowAutoIncrementColumns = false, bool AllowPrimaryKeyColumns = false)
        {
            return DataOutputOperations.BulkTableWrite(ExistingConnection, this, SqlTransaction: SqlTransaction, ForceType: this.GetType(), BatchSize: BatchSize, AllowAutoIncrementColumns: AllowAutoIncrementColumns, AllowPrimaryKeyColumns: AllowPrimaryKeyColumns);
        }
